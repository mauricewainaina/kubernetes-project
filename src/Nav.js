...
function Nav() {
    // https://png.pngitem.com/pimgs/s/76-761418_infinity-symbol-png-red-infinity-symbol-png-transparent.png
    ...
    return (
        <div className={`nav ${show && "nav_black"}`}>
            <img
                className="nav_logo"
                src="https://www.pngfind.com/pngs/m/3-31547_infinity-symbol-png-transparent-png.png"
                alt="infinite logo"
            />
